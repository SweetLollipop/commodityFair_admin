...
export default {
  ...
  data() {
    return {
      ...
      attrIdAndAttrName: "", //收集下拉菜单选中的销售属性的id和name---收集到哪里都可以，在发请求之前整理好数据格式即可
    };
  },
  methods: {
    //照片墙删除某个图片的时候会触发
    ...
    addSaleAttrValue(row, index) {
      ...
      //点击button的时候，重绘重排一个input它是需要耗费时间，因此我们不可能一点击button立马获取到input
